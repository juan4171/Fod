...
con la informaci�n correspondiente a las prendas que se encuentran a la venta. De
cada prenda se registra: cod_prenda, descripci�n, colores, tipo_prenda, stock y
...
quedar�n obsoletas. Deber� implementar un procedimiento que reciba ambos archivos
y realice la baja l�gica de las prendas, para ello deber� modificar el stock de la prenda
correspondiente a valor negativo.
Por �ltimo, una vez finalizadas las bajas l�gicas, deber� efectivizar las mismas
compactando el archivo. Para ello se deber� utilizar una estructura auxiliar, renombrando
el archivo original al finalizar el proceso.. Solo deben quedar en el archivo las prendas
que no fueron borradas, una vez realizadas todas las bajas f�sicas.
